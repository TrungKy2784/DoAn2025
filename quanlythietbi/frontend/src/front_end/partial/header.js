...
import { useTheme } from '../../dark_mod/theme-context';
    ...
    return (
        <div>
            <nav className="relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all ease-in shadow-none duration-250 rounded-2xl lg:flex-nowrap lg:justify-start"
                 data-navbar-main data-navbar-scroll="false">
                <div className="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                    ...
                    <div className="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                        ...
                        <ul className="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                            ...
                            <li className="flex items-center pl-4 xl:hidden">js
                                <a href="javascript:;"
                            ...
                            <li className="flex items-center px-4">
                                <a href="javascript:;"
                                   className="p-0 text-sm text-white transition-all ease-nav-brand">
                                    <i data-fixed-plugin-button-nav className="cursor-pointer fa fa-cog"></i>
                                </a>
                            </li>
